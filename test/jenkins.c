...
struct rez hash( k, length, initval)
...
int main() {
  char key[] = {0x68, 0x65, 0x6c, 0x6c, 0x6f};
  /* char key[] = {0x73, 0x75, 0x64, 0x64, 0x69, 0x76, 0x69, 0x73, 0x69, 0x6F, 0x6E, 0x69}; */
  struct rez r = hash(key, 5, 0xcafebabe);
  printf("%u %u %u\n", r.a, r.b, r.c);
  return 0;
}
